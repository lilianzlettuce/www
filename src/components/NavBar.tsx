...
export default function NavBar() {
  ...
  return (
    <nav className="bg-background/50 backdrop-blur-md border-b border-border sticky top-0 z-50 px-4 sm:px-6 lg:px-8">
      <div className="flex justify-between items-center h-16">
        <Link href="/" className="text-xl font-bold text-foreground hover:text-mutedForeground transition-colors">
          <LogoIcon className="w-[284px] h-full scale-x-100" />
        </Link>
