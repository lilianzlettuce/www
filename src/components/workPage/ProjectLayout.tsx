...
export default function ProjectLayout({ frontmatter, children }: ProjectLayoutProps) {
  return (
    <div className="relative min-h-screen bg-background flex gap-4 justify-between">
      {/* Sticky side info */}
      <div className="hidden sticky top-0 left-0 w-80 h-10 p-8 flex flex-col gap-[340] items-start justify-start">
      ...
      <div className="max-w-6xl mx-auto w-full px-5 sm:px-10 sm:pr-12 py-0">
        <ScrollIndicator className="z-100 fixed top-8 right-4" />
